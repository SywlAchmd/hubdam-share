    ...
    <>
      ...
      <section className="single-section-padding grid min-h-[80vh] gap-5">
        <section className="flex items-center justify-end">
          <InputSearch value={search} placeholder="Cari Nama Staf" onChange={setSearch} onSearch={handleSearch} onReset={handleReset} />
        </section>

        <section className="grid grid-cols-3 place-items-center gap-10 smdlg:grid-cols-2">
          {data.length === 0 ? (
            <p className="col-span-3 text-center text-gray-500">Tidak ada data staf yang ditemukan.</p>
          ) : (
